...
export default function Cart() {
  ...
  if (loading) return <h1 className="text-center m-12">Loading...</h1>;
  if (cartItems.length === 0) return <h1 className="text-center m-12 dark:text-stone-800">Cart is empty</h1>;
