  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f4f1f1] bg-[#C2C2AF] px-10 py-4">
      ...
      <div className="flex flex-1 justify-end gap-8">
        <Link
          href="/cart"
          className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-12 text-[#171212] gap-2 text-xl font-extrabold leading-normal tracking-[0.015em] min-w-0 px-4"
          aria-label="Cart"
        >
